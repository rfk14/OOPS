//define a function MAx that for 3 room object, and returns the room with max surface
...
int main()
{
	...
	room max = Maximum(r1, r2, r3);
	cout << "\nthe room with max surface: ";
		cout << endl << Maximum(r1, r2, r3).type << "\t" << max.width << "\t" << max.length << "\tsurface: "
